...
public class MedicaoController {
    public void executar() {
        ...
        // ListaView.exibirLista(listaAleatoria, "Lista aleatoria");
        tempoFim = System.nanoTime();
        ListaView.exibirTempo("rotina 1", (tempoFim - tempoInicio)/1000000);
        ...
        // ListaView.exibirLista(listaSequencial, "Lista sequencial");
        tempoFim = System.nanoTime();
        ListaView.exibirTempo("rotina 2", (tempoFim - tempoInicio)/1000000);
